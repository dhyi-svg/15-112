...
def onMousePress(app,mouseX,mouseY):
    if app.homeScreen:
        if checkInRect(app,mouseX, mouseY, app.centerx, app.centery+40, app.width//2, 60,):
            app.characterSelect = True
            app.homeScreen = False
    elif app.characterSelect:
        if checkInRect(app,mouseX, mouseY, app.centerx - 60, app.centery - 70, app.width//2, 60,):
